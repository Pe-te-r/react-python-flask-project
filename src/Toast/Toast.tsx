...
//   showToast: (message: string, type: 'info' | 'success' | 'warning' | 'error',time: number) => void;
// }
...
//   const showToast = (message: string, type: 'info' | 'success' | 'warning' | 'error',time= 3000): void => {
//     setToast({ message, type });
//     setTimeout(() => setToast(null), time); // Hide toast after 3 seconds
//   };
...
export const ToastProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // Function to show the toast with a default time of 3000ms (3 seconds)
  const showToast = (message: string, type: 'info' | 'success' | 'warning' | 'error', time = 3000): void => {
    setToast({ message, type });
    setTimeout(() => setToast(null), time); // Hide toast after the specified time or default to 3 seconds
  };
